...
export const LeftBar = () => {
    return <div className="bg-gray-950 w-48 hidden md:block">
        <BarWithIcon name={"Home"}/>
        <BarWithIcon name={"Shorts"}/>
        <BarWithIcon name={"Subscription"}/>
        <Line />
        <BarWithIcon name={"History"}/>
        <BarWithIcon name={"Playlist"}/>
        <BarWithIcon name={"Your Videos"}/>
        <BarWithIcon name={"Watch Later"}/>
        <Line />
...
function BarWithIcon({name}: {name: string;}) {
